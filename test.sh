...
function report_mismatch() {
    ...
    shift
    y="$1"
    g o -2e "\033[1;38;5;160mMismatch\033[0m"
    g o -2e "\033[1;38;5;220mi.e.:\033[0m"
    g o -2e "\033[1;38;5;196m${x} != ${y}\033[0m"
    exit 1
}
function report_ok() {
    g o -2e " \033[1;38;5;112mOK\033[0m i.e.: \033[1;38;5;220m $1\033[0m"
}
...
g o -n "checking sha256sum of ${target} ..."
...
g o -n "checking sha384sum of ${target} ..."
...
g o -n "checking sha512sum of ${target} ..."
